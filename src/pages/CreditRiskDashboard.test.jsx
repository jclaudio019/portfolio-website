...
import CreditRiskDashboard, { getComparableSimulationRows } from "./CreditRiskDashboard";
...
test("renders the overview and explicit monitoring warning", async () => {
    ...
    expect(container.querySelector("a[href$='#reproduce-the-analysis']")).not.toBeNull();
